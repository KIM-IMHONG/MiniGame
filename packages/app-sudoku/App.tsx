...
export default function App() {
  ...
  return (
    <GameWrapper
      ...
      highScore={storeRef.current.getState().getHighScore(SUDOKU_CONFIG.gameId)}
      onHighScoreUpdate={handleHighScoreUpdate}
    >
      {(controls) => <SudokuGame controls={controls} difficulty="medium" />}
    </GameWrapper>
  );
}
